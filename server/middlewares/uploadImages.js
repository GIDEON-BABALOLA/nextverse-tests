...
const multerStorage = multer.diskStorage({
    destination : async (req, file, cb ) => {
        if(!fs.existsSync(path.join(__dirname, "..", 'public', "flutter"))){
            await fsPromises.mkdir(path.join(__dirname, "..",'public', "flutter"),  { recursive: true });
        }
cb(null, path.join(__dirname, "..", "public", "flutter"))
    },
