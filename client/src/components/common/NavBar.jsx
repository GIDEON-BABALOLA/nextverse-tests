...
<h4>&nbsp;&nbsp;Guest</h4>
        ...
        >
                    ...
                    <MdOutlinePersonAddAlt size={20} />
                        ...
                        <Link to={ user && user.role == "admin" ?"/dashboard/analytics" : "/dashboard/publish"} className={`nav-sidebar-link ${currentUrl === "users" && "active"}` } 
                           onClick={dave}
                        >
                        ...
                        <FaUser size={20} />
                           ...
                           <h3 className="litenote-dashboard-h-three">My Profile
                            ...
                            {
                              user ? 
                              <span  className={`nav-sidebar-link ${currentUrl === "login" && "active"}`} 
                              ...
                              <Link  
                              to={"/login"}
                              className={`nav-sidebar-link ${currentUrl === "login" && "active"}`} 
                              style={{cursor : "pointer"}}
                              onClick={dave}>
                              <HiOutlineLogout size={24} />
        
                                 <h3 className="litenote-dashboard-h-three special-modal-client">Sign In</h3>
                              </Link>
                            }
